...
-- at runtime using the environment variable ad_delcont_bindir.
...
-- environment variable ad_delcont_libdir.
...
-- using the environment variable ad_delcont_dynlibdir.
...
-- runtime using the environment variable ad_delcont_datadir.
...
-- using the environment variable ad_delcont_sysconfdir.
...
libdir     = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/ad-delcont-0.5.0.0-inplace"
dynlibdir  = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/tonyday567/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/ad-delcont-0.5.0.0"
libexecdir = "/Users/tonyday567/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/ad-delcont-0.5.0.0"
sysconfdir = "/Users/tonyday567/.cabal/etc"

getBinDir     = catchIO (getEnv "ad_delcont_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "ad_delcont_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "ad_delcont_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "ad_delcont_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "ad_delcont_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "ad_delcont_sysconfdir") (\_ -> return sysconfdir)
