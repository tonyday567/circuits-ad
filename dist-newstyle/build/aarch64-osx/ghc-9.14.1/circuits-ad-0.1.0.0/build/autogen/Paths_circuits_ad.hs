...
-- at runtime using the environment variable circuits_ad_bindir.
...
-- environment variable circuits_ad_libdir.
...
-- using the environment variable circuits_ad_dynlibdir.
...
-- runtime using the environment variable circuits_ad_datadir.
...
-- variable circuits_ad_libexedir.
...
-- using the environment variable circuits_ad_sysconfdir.
...
libdir     = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/circuits-ad-0.1.0.0-inplace"
dynlibdir  = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/tonyday567/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/circuits-ad-0.1.0.0"
libexecdir = "/Users/tonyday567/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/circuits-ad-0.1.0.0"
sysconfdir = "/Users/tonyday567/.cabal/etc"

getBinDir     = catchIO (getEnv "circuits_ad_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "circuits_ad_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "circuits_ad_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "circuits_ad_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "circuits_ad_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "circuits_ad_sysconfdir") (\_ -> return sysconfdir)
